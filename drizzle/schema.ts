...
export const savedAddresses = mysqlTable("savedAddresses", {
  ...
  postalCode: varchar("postalCode", { length: 5 }).default("").notNull(),
...
export const orders = mysqlTable("orders", {
  ...
  pickupPostalCode: varchar("pickupPostalCode", { length: 5 }).default("").notNull(),
  ...
  deliveryPostalCode: varchar("deliveryPostalCode", { length: 5 }).default("").notNull(),
