...
export const translations = {
  tr: {
    ...
    cityDelivery: "İstanbul içi hızlı teslimat", heroTitle: "Şehrin hızını kapınıza taşıyoruz.",
  ...
  en: {
    ...
    cityDelivery: "Fast delivery in Istanbul", heroTitle: "We bring the city’s speed to your door.",
  ...
  ar: {
    ...
    cityDelivery: "توصيل سريع داخل إسطنبول", heroTitle: "نوصّل سرعة المدينة إلى بابك.",
  ...
  ru: {
    ...
    cityDelivery: "Быстрая доставка по Стамбулу", heroTitle: "Доставляем скорость города к вашей двери.",
  ...
  el: {
    ...
    cityDelivery: "Γρήγορη παράδοση στην Κωνσταντινούπολη", heroTitle: "Φέρνουμε την ταχύτητα της πόλης στην πόρτα σας.",
  ...
  it: {
    ...
    cityDelivery: "Consegna rapida a Istanbul", heroTitle: "Portiamo la velocità della città alla tua porta.",
  ...
  de: {
    ...
    cityDelivery: "Schnelle Lieferung in Istanbul", heroTitle: "Wir bringen die Geschwindigkeit der Stadt vor Ihre Tür.",
  ...
  fr: {
    ...
    cityDelivery: "Livraison rapide à Istanbul", heroTitle: "Nous apportons la vitesse de la ville à votre porte.",
