export const RUN_KURYE_CONTRACT_VERSION = "2026-08-18-v1";
...
export const runKuryeContractSections = [
  ...
  },
  {
    ...
    body: "Kurye gönderiyi eksiksiz, hasarsız ve sistemde belirtilen teslimat akışına uygun biçimde taşır. Gerekli sürücü belgesi, araç ruhsatı, muayene ve zorunlu sigorta belgelerini geçerli tutar. Trafik kurallarına, teslimat güvenliğine ve platform talimatlarına uyar.",
  },
  {
  ...
  },
  {
    ...
    body: "Kurye, müşteri adresi, telefon numarası, sipariş içeriği ve ticari bilgileri gizli tutar; bu bilgileri teslimat amacı dışında kullanamaz veya üçüncü kişilerle paylaşamaz. Kişisel veriler yalnızca ilgili mevzuata ve platformun gizlilik kurallarına uygun şekilde işlenir.",
  },
  {
    title: "7. Süre ve fesih",
    body: "Sözleşme kabul edildiği tarihte yürürlüğe girer. Taraflar, yürürlükteki mevzuata ve aralarındaki ticari ilişkinin niteliğine uygun bildirim ve fesih kurallarına göre sözleşmeyi sona erdirebilir. Ağır ihlal, güvenlik riski veya müşteri verilerinin kötüye kullanılması hâlinde platform erişimi geçici olarak sınırlandırılabilir.",
  },
  {
